 ...
 * 
 * import com.ecommerce.controller.ProductCategoryController; import
 * com.ecommerce.model.Product; import com.ecommerce.model.ProductCategory;
 * import com.ecommerce.service.ProductCategoryService; import
 ...
 * 
 * @AutoConfigureMockMvc(addFilters = false) class ProductCategoryTest {
 * 
 * @Mock ProductCategory category;
 * 
 * @MockBean private ProductCategoryService service;
 * 
 ...
 * 
 * @BeforeEach void setup() { category = new ProductCategory(1L, "Supplies",
 * products); products = new ArrayList<>(); }
 * 
 * @Test void testFindAllCategories() throws Exception { // List to compare
 ...
 * 
 * @Test void testupdateCategory() throws Exception { ProductCategory
 * newCategory = new ProductCategory(); newCategory.setCategoryId(1L);
 * newCategory.setCategory("Test"); newCategory.setProducts(products);
